    ...
    <body>
        ...
        <main>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" novalidate>
                ...
                <input type="text" id="alfabeticoObligatorio" name="alfabeticoObligatorio" required style="background-color: yellow" value="<?php echo (isset($_REQUEST['alfabeticoObligatorio']) ? $_REQUEST['alfabeticoObligatorio'] : ''); ?>">
                ...
                <input type="text" id="enteroObligatorio" name="enteroObligatorio" required style="background-color: yellow" value="<?php echo (isset($_REQUEST['enteroObligatorio']) ? $_REQUEST['enteroObligatorio'] : ''); ?>">               
